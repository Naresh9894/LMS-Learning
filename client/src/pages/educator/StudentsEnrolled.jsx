  ...
  return enrolledStudents? (
    <div className='min-h-screen flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border-gray-500/20'>
        <table className='table-fixed md:table-auto w-full overflow-hidden pb-4 border-t bg-gray-500'>
          <thead className='text-gray-900 border-b  border-white 
          text-sm text-left'>
            <tr>
          ...
          <tbody className='text-sm text-white'>
            {enrolledStudents.map((item, index)=>(
              <tr key={index} className='border-b border-black hover:bg-slate-300/20'>
