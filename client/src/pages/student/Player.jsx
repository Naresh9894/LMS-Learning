  ...
  return courseData ? (
    ...
    gap-10 md:px-36'>
     ...
     <div className='md:mt-10'>
      {playerData ? (
        <div className='border border-gray-600 bg-orange-200 rounded-xl shadow-md p-3 md:p-6'>
          <div className='bg-black rounded-lg overflow-hidden'>
            <YouTube videoId={playerData.lectureUrl.split('/').pop()} iframeClassName='w-full aspect-video rounded-lg' /></div>
