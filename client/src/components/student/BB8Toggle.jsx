...
const BB8Toggle = ({ checked, onChange }) => {
  return (
    <>
      <style>{`
        .bb8-wrap { display: inline-flex; align-items: center; gap: 8px; }
        .bb8-label-text { font-size: 0.7rem; font-family: 'DM Sans', sans-serif; color: rgba(212,168,67,0.7); letter-spacing: 0.08em; user-select: none; }
        .bb8-toggle {
          --toggle-size: 9px;
        ...
        .bb8__body::after {
          ...
          width:.188em; height:.188em; background:rgb(236,236,236); border-radius:50%;
          box-shadow:.875em .938em,0 -1.25em,.875em -2.125em,2.125em -2.125em,3.063em -1.25em,3.063em 0,2.125em .938em;
          color:rgb(236,236,236);
        }
        .bb8__body::before {
          content:""; width:2.625em; height:2.625em; position:absolute; border-radius:50%;
        ...
        .bb8__shadow {
          width:var(--bb8-diameter); height:20%; border-radius:50%;
          background:#3a271c; box-shadow:.313em 0 3.125em #3a271c;
          opacity:0.25; position:absolute; bottom:0;
          left:calc(var(--toggle-offset) - .938em);
          transition:var(--transition); transform:skew(-70deg); z-index:1;
        }
