      ...
      <Link
        ...
        style={{
          ...
          boxShadow: pageTheme.isDark
            ...
            : '0 4px 24px rgba(0,0,0,0.08)',                      // ✅ lighter shadow in light
          textDecoration: 'none',
      ...
      >
        ...
        <div className='p-4 flex flex-col flex-1 gap-1.5'>
          ...
          <div className='flex items-center gap-1.5'>
            <span className='text-xs font-bold' style={{ color: theme.gold.bright }}>
              {rating}
            </span>
            <div className='flex'>
              {[...Array(5)].map((_, i) => (
                <img key={i}
                  ...
                  style={{ filter: i < Math.floor(rating) ? 'sepia(1) saturate(4) hue-rotate(5deg)' : 'brightness(0.4)' }}
                />
              ))}
            </div>
            ...
            <div className='flex items-baseline gap-2'>
              ...
              {hasDiscount && (
                <span className='text-xs line-through'
                  style={{ color: pageTheme.textMuted, transition: 'color 0.4s ease' }}>  {/* ✅ */}
